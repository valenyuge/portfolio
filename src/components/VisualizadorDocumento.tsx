const VisualizadorDocumento = ({ url, titulo }: { url?: string, titulo: string }) => {
  ...
  return (
    <div className="mt-16 space-y-6 w-full"> 
      <h3 className="font-syne font-bold text-base md:text-xl tracking-tight text-stone-900 dark:text-[#F3EFE6] border-b border-stone-300 dark:border-[#2C2A26] pb-4">
        {titulo}
      </h3>
