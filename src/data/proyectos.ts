...
export const proyectos: Proyecto[] = [
    ...
    {
      id: "oniria",
      titulo: "Oniria - Vagari",
      titulo_en: "Oniria - Vagari",
      fechaInicio: "2026-09",
      fechaFin: "2026-10",
      descripcion: "Experiencia web interactiva e inmersiva desarrollada para Grupo Oniria.",
      descripcion_en: "Interactive and immersive web experience developed for Grupo Oniria.",
      contenidoLargo: "Desarrollo de la plataforma web interactiva Vagari para Grupo Oniria. La experiencia cuenta con una cuidada dirección de arte, navegación fluida, animaciones dinámicas con Framer Motion, diseño responsivo optimizado con TailwindCSS y arquitectura en React.",
    ...
    {
      id: "club-tolosano",
      titulo: "Club Tolosano",
      titulo_en: "Club Tolosano",
      fechaInicio: "2026-06",
      fechaFin: "2026-08",
      descripcion: "Sitio web para el club de fútbol Tolosano desarrollado exclusivamente en HTML, CSS y JavaScript.",
      descripcion_en: "Website for Tolosano football club developed exclusively with HTML, CSS, and JavaScript.",
      contenidoLargo: "Diseño y desarrollo del sitio web para el club de fútbol Tolosano, construido desde cero utilizando exclusivamente HTML5 semántico, CSS3 y JavaScript puro (Vanilla JS). Enfoque en rendimiento óptimo, accesibilidad, identidad visual del club y compatibilidad multidispositivo sin librerías externas.",
